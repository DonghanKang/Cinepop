      ...
      <div class="main">
        ...
        <section class="module" id="team">
          <div class="container">
            ...
            <div class="row">
              <c:forEach var="movieVo" items="${listMovie}">
              	<input type="hidden" value="${movieVo.MNO}">
	              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
	                <div class="team-item">
	                  <div class="team-image"><img src="<c:url value='/resources/images/movie/${movieVo.IMAGE1 }'/>" alt="${movieVo.MNAME }"/>
	                    <div class="team-detail">
							<a href="<c:url value='/ticketing/ticketing'/>" class="btn_a">예매하기</a>              
							<a href="<c:url value='/movie/movieDetail?MNO=${movieVo.MNO}'/>" class="btn_a">상세보기</a>              
	                    </div>
	                  </div>
	                  <div class="team-descr font-alt">
	                    <div class="team-name">${movieVo.MNAME }</div>
